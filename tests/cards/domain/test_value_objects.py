...
@pytest.mark.parametrize(
    ...
    [
        (
            {"dice_count": 0, "die_sides": 4},
            "当 dice_count 为 0 时，die_sides 也必须为 0",
        ),
        (
            {"dice_count": 1, "die_sides": 0},
            "当 dice_count 大于 0 时，die_sides 必须大于 0",
        ),
        (
            {"flat": 1, "dice_count": 1, "die_sides": 4},
            "flat 加值和骰子加值必须分开表示",
        ),
    ],
)
